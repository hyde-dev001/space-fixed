...
$routeBuckets = [
    'core' => [
        ...
        'shop-owner.action-center.summary',
    ...
    'repair_operations' => [
        ...
        'shop_owner.repair-price-changes.show',
        ...
        'shop_owner.repair-refunds.show',
    ...
    'hr_employees' => [
        ...
        'api.manager.termination_requests.index',
        'api.manager.termination_requests.review',
        'api.manager.termination_requests.show',
        'api.manager.rehire_requests.index',
        'api.manager.rehire_requests.review',
        'api.manager.rehire_requests.show',
        ...
        'hr.termination_requests.index',
        'hr.termination_requests.show',
        'hr.termination_requests.store',
        'hr.rehire_requests.index',
        'hr.rehire_requests.show',
        'hr.rehire_requests.store',
        ...
        'shop_owner.termination_requests.index',
        'shop_owner.termination_requests.review',
        'shop_owner.termination_requests.show',
        'shop_owner.rehire_requests.index',
        'shop_owner.rehire_requests.review',
        'shop_owner.rehire_requests.show',
    ...
    'procurement' => [
        ...
        'procurement.purchase-orders.receipts.items.post-payment-issues',
        ...
        'procurement.supplier-adjustments.evidence',
        'procurement.supplier-adjustments.index',
        'procurement.supplier-adjustments.show',
        ...
        'shop_owner.purchase-requests.show',
    ],
    'logistics' => [
...
$routeMethods = static function (string $routeName): array {
    $overrides = [
        ...
        'procurement.purchase-orders.receipts.items.post-payment-issues' => ['POST'],
