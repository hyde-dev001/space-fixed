...
export default function RepairRejectReview() {
	...
	useEffect(() => {
		// Allow access if user is logged in as regular user or shop owner
		const isAuthenticated = auth?.user || auth?.shop_owner;
		...
		<AppLayoutShopOwner>
			...
			<div className="p-6 space-y-6">
				<div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
					<div>
						<h1 className="text-2xl font-semibold mb-1 text-gray-900 dark:text-white">My Repair Rejection Status</h1>
						<p className="text-gray-600 dark:text-gray-400">View and manage your repair rejection requests</p>
					</div>
					<div />
				</div>
				...
				<div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-6 shadow-sm">
					<div className="mb-4">
						<h2 className="text-lg font-semibold text-gray-900 dark:text-white">My Repair Requests</h2>
						<p className="text-sm text-gray-500 dark:text-gray-400">View the status of your repair requests and rejection decisions</p>
					</div>
