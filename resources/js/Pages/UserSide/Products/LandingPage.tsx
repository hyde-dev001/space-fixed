...
const LandingPage: React.FC<Props> = ({ products = [] }) => {
  ...
  const buttonBaseClass =
    'group inline-flex items-center justify-center gap-3 rounded-full px-8 py-3.5 text-xs font-semibold uppercase tracking-[0.18em] transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 sm:px-10 sm:py-4 sm:text-sm';
  ...
  return (
    <>
      ...
      <section className="relative flex min-h-screen w-full items-center overflow-hidden">
        ...
        <div className="mx-auto flex min-h-screen w-full max-w-[1920px] items-center px-6 py-24 lg:px-12 lg:py-32">
          <div className="max-w-4xl relative z-10">
            <h1 className="hero-headline text-6xl lg:text-8xl xl:text-9xl font-bold text-white/85 mb-8 leading-[0.9] tracking-tight">
            ...
            <p className="hero-description text-xl lg:text-2xl text-white/85 mb-12 max-w-2xl leading-relaxed font-light">
            ...
            {products.length > 0 ? (
              products.map((product, index) => {
                ...
                <Link
                  ...
                  className="scroll-reveal group overflow-hidden rounded-3xl border border-slate-300 bg-white shadow-[0_16px_35px_-24px_rgba(15,23,42,0.45)] transition-all duration-300 hover:-translate-y-1 hover:border-slate-400 hover:shadow-[0_28px_48px_-24px_rgba(15,23,42,0.55)]"
                ...
                >
                  ...
                  <div className="border-t border-slate-200 p-8">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <div className={`${buttonBaseClass} ${buttonDarkClass}`}>
                        View
                      </div>
                    </div>
                  </div>
