        ...
        <div className="bg-white border-b border-gray-200 relative">
          <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6 sm:py-12">
            ...
            <div data-testid="shop-profile-desktop-actions" className="mb-6 flex w-full flex-row gap-2 sm:absolute sm:right-6 sm:top-6 sm:mb-0 sm:w-auto sm:flex-col">
              <div ref={desktopActionMenuRef} data-testid="shop-profile-desktop-action-menu" className="relative z-30 flex justify-end">
                <button
                  type="button"
                  onClick={() => setIsActionMenuOpen((prev) => !prev)}
                  className="inline-flex h-10 w-10 items-center justify-center rounded-full bg-white text-gray-700 shadow-lg ring-1 ring-black/10 transition hover:bg-gray-50"
                  aria-label="Open menu"
                  title="More actions"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
