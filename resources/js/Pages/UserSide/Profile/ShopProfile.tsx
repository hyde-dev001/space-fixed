      ...
      <main className="hidden xl:block flex-1 pt-0">
        ...
        <div className="bg-white border-b border-gray-200 relative">
          <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6 sm:py-12">
            {/* Profile actions */}
            <div data-testid="shop-profile-desktop-actions" className="mb-6 flex w-full flex-row gap-2 sm:absolute sm:right-6 sm:top-6 sm:mb-0 sm:w-auto sm:flex-col">
              <div data-testid="shop-profile-desktop-primary-actions" className="flex items-center justify-end gap-2">
                <button
                  type="button"
                  onClick={() => setIsFollowing((prev) => !prev)}
                ...
                <div ref={desktopActionMenuRef} data-testid="shop-profile-desktop-action-menu" className="relative z-30 shrink-0">
                  <button
                    type="button"
                    onClick={() => setIsActionMenuOpen((prev) => !prev)}
                    className="inline-flex h-10 min-h-11 w-10 min-w-11 items-center justify-center bg-transparent text-gray-700 transition-colors hover:text-black focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-900 focus-visible:ring-offset-2"
                    aria-label="Open menu"
                  ...
                  {isActionMenuOpen && (
                    <div className="absolute right-0 top-full mt-2 w-48 overflow-hidden rounded-xl border border-gray-200 bg-white py-1 shadow-xl ring-1 ring-black/5">
                      <button
                        type="button"
                        onClick={() => {
                          setIsActionMenuOpen(false);
