...
const resolveImageUrl = (item: RepairMaterialInventoryItem): string => {
  ...
  if (!path) return "/images/product/product-01.jpg";
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
                {isLoading ? (
                  <tr>
                    <td colSpan={7} className="py-8 text-center text-gray-500">Loading stocks...</td>
                  </tr>
                ) : paginatedItems.length === 0 ? (
                  <tr>
                    <td colSpan={7} className="py-8 text-center text-gray-500">No repair materials found.</td>
                  </tr>
                ) : (
                  paginatedItems.map((item) => (
                    <tr key={item.id}>
                      <td className="py-3">
                        <div className="flex items-center gap-3">
                          <div className="h-12 w-12 overflow-hidden rounded-md bg-gray-100 dark:bg-gray-800">
                            <img src={resolveImageUrl(item)} alt={item.name} className="h-full w-full object-cover" />
                          </div>
                      ...
                      <td className="py-3 text-gray-900 dark:text-gray-100">{formatPeso(item.price)}</td>
                      <td className="py-3">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-2xl w-full">
              ...
              <div className="p-6 grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-lg font-semibold text-gray-900 dark:text-white">{formatPeso(selectedItem.price)}</p>
                </div>
              </div>
            </div>
          </div>
