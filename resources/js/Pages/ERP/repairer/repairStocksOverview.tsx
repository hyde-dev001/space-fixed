      ...
      <div className="p-6 space-y-6">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400">Monitor repair-related stock levels and item availability (Read-only)</p>
          </div>
        ...
        <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-6 shadow-sm">
          <div className="mb-4">
            <h2 className="text-lg font-semibold">Repair Stocks Inventory</h2>
            <p className="text-sm text-gray-500">View all stock items and their availability for repair operations</p>
          </div>
