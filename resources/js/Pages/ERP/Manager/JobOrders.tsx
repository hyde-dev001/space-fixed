...
import ManagerFilterPanel from "../../../components/manager/ManagerFilterPanel";
import {
        ...
        <AppLayoutERP>
            ...
            <main className="space-y-6 py-6 md:py-8" aria-labelledby="manager-job-orders-title">
                <ManagerFilterPanel
                    ...
                    description="Use reassignment required to find work whose current handler is no longer eligible."
                    metadata={
                        <>
