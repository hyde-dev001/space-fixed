  ...
  return (
    <AppLayoutERP>
      ...
      <div data-testid="procurement-dashboard" className="w-full space-y-6 px-4 py-6 sm:px-6 lg:py-8">
        <section data-testid="procurement-module-summary" className="metrics-card overflow-hidden rounded-2xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900 sm:p-8">
        ...
        <section aria-labelledby="procurement-health-title" className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-white/[0.03] sm:p-7">
          <div className="flex flex-col justify-between gap-2 sm:flex-row sm:items-end">
            <div>
              <p className="text-xs font-semibold uppercase tracking-[0.18em] text-[#111111] dark:text-blue-400">Procurement health</p>
