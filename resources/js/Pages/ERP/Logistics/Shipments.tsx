                            ...
                            return (
                              <div key={leg.id} className="flex flex-col gap-3 rounded-lg border border-gray-200 bg-white p-4 sm:flex-row sm:items-center sm:justify-between dark:border-gray-700 dark:bg-gray-800">
                                ...
                                <div className="flex flex-wrap gap-2">
                                  ...
                                  {riderMode && ['assigned', 'picked_up', 'in_transit', 'delivery_attempted'].includes(leg.status) && <button type="button" onClick={() => void reportIssue(leg.id)} className="rounded-lg border border-amber-300 px-3 py-2 text-sm font-semibold text-amber-800 hover:bg-amber-50">Report issue / Request cancellation</button>}
