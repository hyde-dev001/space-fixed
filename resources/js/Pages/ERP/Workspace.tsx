...
const ModuleCard = ({ module }: { module: ModuleSummary }) => {
    ...
    <>
      ...
      <div className="min-w-0">
        <div className="lg:flex lg:items-start lg:justify-between lg:gap-3">
          ...
          <span className="hidden shrink-0 items-center gap-1.5 rounded-full border border-blue-100 bg-blue-50 px-2.5 py-1 text-[11px] font-semibold text-blue-700 lg:inline-flex dark:border-blue-500/20 dark:bg-blue-500/10 dark:text-blue-200">
  ...
  return (
    <Link
      ...
      className="group flex items-start gap-4 rounded-xl border border-gray-200 bg-white p-5 transition hover:-translate-y-0.5 hover:border-blue-300 hover:shadow-theme-sm focus:outline-none focus:ring-2 focus:ring-blue-500/40 lg:min-h-40 lg:rounded-2xl lg:p-6 lg:shadow-theme-xs dark:border-gray-800 dark:bg-gray-900 dark:hover:border-blue-500"
    >
      {content}
    </Link>
  );
        ...
        <section className="rounded-2xl border border-gray-200 bg-white p-6 shadow-theme-sm dark:border-gray-800 dark:bg-gray-900 sm:p-8 lg:rounded-3xl lg:border-gray-200/80 lg:p-10">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between lg:gap-10">
            ...
            <div className="flex flex-wrap items-center gap-3 lg:justify-end lg:pt-1">
              <span className="inline-flex items-center rounded-full bg-blue-50 px-3 py-1.5 text-xs font-semibold text-blue-700 lg:border lg:border-blue-100 lg:px-4 lg:py-2 dark:bg-blue-500/10 dark:text-blue-200">
                Owner mode
              </span>
              <Link
                href={props.urls.portal}
                className="inline-flex min-h-11 items-center justify-center rounded-lg border border-gray-200 px-4 py-2 text-sm font-semibold text-gray-700 transition hover:border-blue-300 hover:text-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500/30 lg:min-w-[13.5rem] lg:whitespace-nowrap lg:shadow-theme-xs dark:border-gray-700 dark:text-gray-200 dark:hover:border-blue-500 dark:hover:text-blue-200"
              >
        ...
        <section aria-labelledby="unavailable-modules-title" className="space-y-4 lg:space-y-5">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
            ...
            <Link
              ...
              className="inline-flex min-h-11 items-center justify-center rounded-lg bg-blue-600 px-4 py-2 text-sm font-semibold text-white transition hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500/40 lg:min-w-[9rem] lg:shadow-theme-sm"
            >
              Manage modules
            </Link>
          </div>
