...
const AppHeader_ERP: React.FC = () => {
  ...
  return (
    <header className="erp-header relative sticky top-0 z-99999 flex w-full bg-white/80 backdrop-blur-md dark:bg-gray-900/80 xl:border-b xl:border-gray-200 xl:dark:border-gray-800">
        ...
        <div className="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-gray-200 dark:border-gray-800 sm:gap-4 xl:justify-normal xl:border-b-0 xl:px-0 xl:py-4">
          ...
          <div className="flex items-center gap-1 xl:hidden">
            ...
            <button
              ...
              className="flex h-10 w-10 items-center justify-center rounded-xl text-gray-700 transition-colors hover:bg-gray-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-black dark:text-gray-400 dark:hover:bg-gray-800 dark:focus-visible:ring-white"
            ...
            <form>
              <div className="relative">
                ...
                <input
                  ...
                  className="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-200 bg-transparent py-2.5 pl-12 pr-14 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-black focus:outline-hidden focus:ring-3 focus:ring-black/10 dark:border-gray-800 dark:bg-gray-900 dark:bg-white/[0.03] dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-white xl:w-[430px]"
                />
