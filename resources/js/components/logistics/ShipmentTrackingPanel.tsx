...
function DeliveryProofDialog({
  ...
  return (
    <div
      ...
      className="fixed inset-0 z-[100] flex items-center justify-center bg-black/25 p-0 sm:p-6 erp-modal-backdrop"
    >
      ...
      {lightboxOpen && !failed && (
        <div
          ...
          className="fixed inset-0 z-[110] flex items-center justify-center bg-black/80 p-4 sm:p-8 erp-modal-backdrop"
          onClick={(event) => {
