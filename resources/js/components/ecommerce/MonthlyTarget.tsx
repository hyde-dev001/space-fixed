...
export default function MonthlyTarget({ thisMonth = 0, lastMonth = 0 }: MonthlyTargetProps) {
  ...
  const options: ApexOptions = {
    colors: [isGrowthPositive ? "#039855" : "#D92D20"],
    chart: {
    ...
    <div className="rounded-2xl border border-gray-200 bg-gray-100 dark:border-gray-800 dark:bg-white/[0.03]">
      <div className="px-5 pt-5 bg-white shadow-default rounded-2xl pb-11 dark:bg-gray-900 sm:px-6 sm:pt-6">
        ...
        <p className="mx-auto mt-10 w-full max-w-[380px] text-center text-sm text-gray-500 sm:text-base">
          {thisMonth > 0 
            ? isGrowthPositive
              ? `You earned ${formatCurrency(thisMonth)} this month, it's higher than last month. Keep up your good work!`
              : `You earned ${formatCurrency(thisMonth)} this month. Let's aim higher next month!`
            : "No revenue data for this month yet. Start making sales!"
          }
        </p>
      </div>
          ...
          <p className="flex items-center justify-center gap-1 text-base font-semibold text-gray-800 dark:text-white/90 sm:text-lg">
            ...
            >
              <path
                ...
                fill={isGrowthPositive ? "#039855" : "#D92D20"}
              />
            </svg>
          </p>
        </div>
