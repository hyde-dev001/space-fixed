        ...
        {links.map((link) => {
          ...
          return (
            <Link
              ...
              className={`backoffice-nav-item inline-flex min-h-11 shrink-0 items-center justify-center rounded-t-lg border-b-2 px-4 py-2 text-sm font-semibold transition-colors motion-reduce:transition-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#111111] focus-visible:ring-offset-2 dark:focus-visible:ring-gray-300 dark:focus-visible:ring-offset-gray-950 ${
                isCurrent
                  ? 'border-[#111111] bg-[#111111] text-white dark:border-[#111111] dark:bg-[#111111] dark:text-white'
                  : 'border-transparent text-gray-600 hover:border-gray-300 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-300 dark:hover:border-gray-600 dark:hover:bg-gray-800 dark:hover:text-white'
              }`}
            >
              {link.label}
            </Link>
