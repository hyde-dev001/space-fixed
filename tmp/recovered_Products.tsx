...
>>>>>>> dca82ddc7231ed2e00b05c0aec5d5b019ead4dc0
interface Props {
...
<<<<<<< HEAD
                    <div className="p-3.5 flex flex-col flex-grow">
                      ...
                      {shopDist !== null && (
                        <p className="text-xs text-black/50 mb-2">=ƒτμ {formatDistance(shopDist)}</p>
                      )}
                      
                      <div className="flex items-baseline justify-between mt-auto pt-2.5 border-t border-gray-100">
                        <div className="flex flex-col gap-0.5">
                          <div className="text-lg font-bold text-black">Gι¦{p.price.toLocaleString()}</div>
                          {p.compare_at_price && p.compare_at_price > p.price && (
                            <div className="text-xs text-gray-400 line-through">Gι¦{p.compare_at_price.toLocaleString()}</div>
                          )}
                        </div>
...
=======
                    <div className="border-t border-gray-200 p-3.5 flex flex-col h-[194px]">
                      ...
                      <div className="min-h-[1.1rem] mb-1.5">
                        {shopDist !== null && (
                          <p className="text-xs text-black/50">=ƒτμ {formatDistance(shopDist)}</p>
                        )}
                      </div>
                      ...
                      <div className="flex items-baseline justify-between mt-auto pt-3 border-t border-gray-200">
                        <div className="flex flex-col gap-0.5">
                          <div className="text-lg font-bold text-black">Gι¦{p.price.toLocaleString()}</div>
                          {p.compare_at_price && p.compare_at_price > p.price && (
                            <div className="text-xs text-black/40 line-through">Gι¦{p.compare_at_price.toLocaleString()}</div>
                          )}
                        </div>
