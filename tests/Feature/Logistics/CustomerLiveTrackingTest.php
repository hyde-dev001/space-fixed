...
class CustomerLiveTrackingTest extends TestCase
{
    ...
    public function test_customer_tracking_includes_only_their_safe_current_rider_location(): void
    {
        ...
        $this->actingAs($customer, 'user')
            ...
            ->assertOk()
            ->assertJsonPath('shipment.delivery_type', 'retail_delivery')
            ->assertJsonPath('shipment.delivery_label', 'Retail Delivery')
            ->assertJsonPath('shipment.legs.0.delivery_label', 'Retail Delivery')
